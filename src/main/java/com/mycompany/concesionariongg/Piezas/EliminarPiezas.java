 ...
 * @author nesto
 */
public class EliminarPiezas extends javax.swing.JFrame {

    Conexion conexion = new Conexion();

    /**
     * Creates new form EliminarPiezas
     */
    ...
    private void jButtonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEliminarActionPerformed
        ...
        //Se guardan todos los datos introducidos en los jtextfield y se modifican para tener la primera letra en mayuscula
        ...
        //Se crea un documento con los datos introducidos
        ...
        //Si se encuentran se borran,se avisa por mensaje y se vacian los jtextfield
        if (encontrado) {
            JOptionPane.showMessageDialog(this, "Datos eliminados correctamente", "Aviso", JOptionPane.WARNING_MESSAGE);
            conexion.col_Piezas.deleteOne(d1);
            ...
            //Si no se encuentran se avisa por mensaje y se vacian los jtextfield
            JOptionPane.showMessageDialog(this, "Los datos no existen", "Error de datos", JOptionPane.ERROR_MESSAGE);
            jTextFieldPieza.setText("");
            jTextFieldMarca.setText("");
            jTextFieldModelo.setText("");
            jTextFieldAnyo.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarPiezas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new EliminarPiezas().setVisible(true);
            }
        });
    }
