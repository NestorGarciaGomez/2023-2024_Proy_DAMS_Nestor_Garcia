 ...
 * @author nesto
 */
public class DatosPieza extends javax.swing.JFrame {
    ...
    /**
     * Creates new form DatosPieza
     */
    public DatosPieza() {
        initComponents();
        //Se establece el titulo de la ventana
        setTitle("CONCESIONARIO NGG");
        //Se cambia el color de fondo de la ventana y del jpanel
        ...
        //Añadir titulo
        jLabelTitulo.setText("ConcesionarioNGG:Resumen " + pieza);
        ...
        //Añadir parrafo
        jLabelParrafo.setText("A continuacion puede consultar la informacion de la pieza solicitada");
        ...
        //Añadir imagen
        String ruta = "C:/Users/nesto/Documents/NetBeansProjects/ConcesionarioNGG/imagenes/Piezas/" + pieza + ".png";
        ...
        //Se establecen las distancias de los bordes del jpanel
    ...
    private void jButtonVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVenderActionPerformed
        ...
        //Se avisa por mensaje
        JOptionPane.showMessageDialog(this, "La Pieza se ha vendido correctamente.", "Warning", JOptionPane.WARNING_MESSAGE);
        //Se crea un documento con los datos y se eliminan
        Document d1 = new Document();
        d1.append("Pieza", pieza);
        d1.append("Marca", marca);
        d1.append("Modelo", modelo);
        d1.append("Anyo", anyo);
        d1.append("Precio", precio);
        conexion.col_Piezas.deleteOne(d1);
        //Se abre la ventana de piezas y se cierra la actual
        Piezas newframe = new Piezas();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DatosPieza.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DatosPieza().setVisible(true);
            }
        });
    }
    ...
    private void crearTabla() {
        //Se establece el modelo de la tabla y se añaden las columnas y las filas
        ...
        jTableInfo.setFont(new Font("Arial", Font.BOLD, 14));

    }

    private void crearPdf() {
        String archivo = "C:/Users/nesto/Desktop/Resumen" + pieza + ".pdf";
        String titulos = "CONCESIONARIOS NGG:Resumen " + pieza + " " + marca + " " + modelo;
        String parrafo = "El cliente durante el proceso de venta de la pieza ha escogido:" + pieza + " del " + marca + " " + modelo + " del anyo:" + anyo + ". Y desea tener en un documento guardada toda la infromacion de la pieza adquirida,por ello se le hace entrega de este documento donde el cliente,conforme con su decisión,puede consultar toda la información de la pieza.Este documento queda aprobado por ConcesionariosNGG para ser entregado al cliente correspondiente.";
        try {
            ...
            tabla.addCell("PIEZA").setBold().setFontSize(18);
            tabla.addCell(pieza).setFontSize(12);
            ...
            tabla.addCell("Coste Total de la pieza:").setBold().setFontSize(18);
            tabla.addCell(precio + "€").setFontSize(12);
            tabla.setHorizontalAlignment(HorizontalAlignment.CENTER).setMarginBottom(20);
            documento.add(tabla);
            //Añadir imagen
            Image imagen = new Image(ImageDataFactory.create("C:/Users/nesto/Documents/NetBeansProjects/ConcesionarioNGG/imagenes/Piezas/" + pieza + ".png"));
            ...
            Paragraph fechayhora = new Paragraph("Valencia," + fechaformato + " a las " + horaformato + " horas.").setFontSize(10).setTextAlignment(TextAlignment.RIGHT).setMarginTop(70);
